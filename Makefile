...
wasm: solitaire.c solitaire.h
	emcc $(CFLAGS) $(WASM_FLAGS) -o index.html solitaire.c -sUSE_SDL=2 -sUSE_SDL_IMAGE=2 -sSDL2_IMAGE_FORMATS='["png"]' -sMAX_WEBGL_VERSION=2 --preload-file ./img -lm -lGL --shell-file shell_file_tamplate.html
